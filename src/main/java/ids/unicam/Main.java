...
@ComponentScan(basePackages = {"ids.unicam.DataBase", "ids.unicam.models.users.organizzazioneComune", "ids.unicam.Service", "ids.unicam.DataBase.Repository", "ids.unicam.controller"})
