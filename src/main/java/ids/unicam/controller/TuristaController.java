...
public class TuristaController {
    ...
    public ResponseEntity<?> getByTag(
            @Parameter(description = "Tag cercato") @PathVariable @NotNull String tag) {
    ...
    public ResponseEntity<?> report(
            ...
            @Parameter(description = "Messaggio della Segnalazione") @RequestParam @NotNull String messaggio) {
        try {
